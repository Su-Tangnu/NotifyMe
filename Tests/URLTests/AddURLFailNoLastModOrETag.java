...
public class AddURLFailNoLastModOrETag {
  ...
  @Test
  public void testAddURLFailNoLastModOrETag() throws Exception {
    ...
    driver.findElement(By.id("newURLInput")).clear();
    driver.findElement(By.id("newURLInput")).sendKeys("reddit.com");
    driver.findElement(By.id("addURLInput")).click();
  }

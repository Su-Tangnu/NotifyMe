...
public class EditURLFailNoLastModOrETag {
  ...
  @Test
  public void testEditURLFailNoLastModOrETag() throws Exception {
    ...
    driver.findElement(By.id("editURLInput")).sendKeys("reddit.com");
    driver.findElement(By.id("editURLSubmitInput")).click();
    driver.findElement(By.id("editCancelInput")).click();
  }
